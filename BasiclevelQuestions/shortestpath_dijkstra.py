# All source shortestPath - floyd warshall Algorithm (DP)
# Single Source shortestPath - Dijkstra Algorithm (GREEDY) (and Bellman Ford if neg edges)
import heapq
...
def shortestPath(graph,src,dest):
    ...
    # greedy  method : Sourse -> MIN - > MIN -> MIN -> Destination
